...
# user accounts to act as the project Terraform service account. This file
# defines the initialisation of q google provider that is acting as the named
# service account, assuming that the invoking user account has the permissions
# to create an authentication token for the service account.
...
# Instantiate unaliased google providers that are using the token associated
